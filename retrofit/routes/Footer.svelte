<script>
	...
	setContext('embed', { isEmbeded, embedSource: false });
</script>
...
>
	...
	{#if !isEmbeded}
		<ul class="flex flex-wrap gap-x-4 gap-y-3 text-gray-600 md:justify-end">
			<li>
				<a href="/liste-aides" class="hover:(underline text-sky-600)">Liste des aides</a>
			</li>
			<li>
				<a href="/statistiques" class="hover:(underline text-sky-600)">Stats</a>
			</li>
			<li>
				<a href="/mentions-legales" class="hover:(underline text-sky-600)">Mentions légales</a>
			</li>
			<li>
				<a
