...
{#if montant.nodeValue !== 0}
	<a tabindex="0" data-sveltekit-noscroll {href} rel={relNoFollow ? 'nofollow' : null}>
		<div
			role="row"
			class="flex gap-x-2 px-2 sm:(gap-x-4 px-4) items-center justify-between py-2 bg-white hover:bg-neutral-50 transition cursor-pointer border-b group"
		>
			...
			<div class="fill-gray-300 group-hover:fill-s4-green">
